// Wrap all code that interacts with the DOM in a call to jQuery to ensure that
  ...
  // Wait until the DOM is fully loaded before pushing the code inside the function.
  $(function () {
    // Get the current hour of the day using the dayjs library node.js.
  ...
  // The  function below will save the user's input in a textarea to localStorage.
   ...
   //Function below will refresh the color of each time block based on whether it's in the past, present, or future depending on the time. 
